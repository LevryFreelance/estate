...
class Estate:
    ...
    def to_list(self):
        return {"year": self.year, "month": self.month, "day": self.day, "country": self.country, "resource": self.resource, "deal_type": self.deal_type, "property_type": self.property_type, "city_region": self.city_region, "district": self.district,
